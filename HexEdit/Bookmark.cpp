...
// the same form).  For example GetSetLast("unnamed") would return 12 if there
// existed bookmarks with the names:
// unnamed001
// unnamed2
// unnamed011
// unnamed22not_matched
...
#if 0   // xxx temporary change for versions 3.0 on until bookmarks store more info (comments?)
