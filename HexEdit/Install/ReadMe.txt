...
A single-user licence is available for $40 US.  Multi-user or site licences 
are available at a discount on request.  The unregistered version works exactly
...
Hexed3_2.msi is a Microsoft Installer file that will install all
required files on your system (apart from MFC DLLs - see below).

To install Hexedit start hexed3_2.msi and follow the instructions.
...
MSVCR71.DLL and MFC71.DLL.  If you do not have these files. for example,
...
can download the full install from our web site or download the
DLLs from the Internet (eg www.dll-files.com or www.driverskit.com).
...
or send email to support@hexedit.com.  (Make sure to include the word
